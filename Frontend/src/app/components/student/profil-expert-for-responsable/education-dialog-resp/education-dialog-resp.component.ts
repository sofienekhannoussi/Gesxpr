...
@Component({
  selector: 'app-education-dialog-resp',
  templateUrl: './education-dialog-resp.component.html',
  styleUrls: ['./education-dialog-resp.component.scss']
})
export class EducationDialogRespComponent implements OnInit, OnDestroy {
