...
@Component({
  selector: 'app-skills-dialog-resp',
  templateUrl: './skills-dialog-resp.component.html',
  styleUrls: ['./skills-dialog-resp.component.scss']
})
export class SKillsDialogRespComponent implements OnInit {
  isEditing: boolean[] = [];
