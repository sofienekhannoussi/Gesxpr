...
@Component({
  selector: 'app-educations-popup',
  templateUrl: './educations-popup.component.html',
  styleUrls: ['./educations-popup.component.scss']
})
export class EducationsPopupComponent implements OnInit , AfterViewInit , OnDestroy {
