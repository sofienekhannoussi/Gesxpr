...
export class routes {
  ...
  public static get demande(): string {
    return this.students + 'demande';
  }
  ...
  public static get quijesuis(): string {
    return this.auth + 'register-page/quijesuis';
  }
  public static get registerexpert(): string {
    return this.auth + 'register-page/registerexpert';
  }
